  ...
  return (
    <main>
        ...
        <div className="mx-auto max-w-editorial px-6 py-16 md:py-24">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
            {STATS.map(({ value, caption }) => (
              <div
                key={value}
                className="comic-panel comic-panel--teal flex flex-col justify-between gap-4 p-8"
              >
      ...
      <ScrollReveal as="section" className="border-y border-gaip-black">
        <div className="mx-auto max-w-editorial px-6 py-16 md:py-24">
          <blockquote className="pull-quote max-w-prose text-2xl text-gaip-black md:text-3xl">
